 ...
 */
public class TaskGroup extends com.seller.page.AbstractPageEntity implements Serializable {
    /**
     * 编号
     */
    private Integer id;
 ...
 4:电脑淘宝；5:电脑天猫；6:电脑直通车
    ...
    /**
     * 要求买手年龄：0:无要求；1:18-24；2:25-30；
     * @return CONDITION_AGE 要求买手年龄：0:无要求；1:18-24；2:25-30；
     */
    ...
    /**
     * 要求买手年龄：0:无要求；1:18-24；2:25-30；
     * @param conditionAge 要求买手年龄：0:无要求；1:18-24；2:25-30；
     */
 ...
 3:4|5:1（表示03:00有4个任务，05:00有1个任务）
     ...
     * 管理员后台对任务组的审核结果：
 0:未通过；1:已通过
     * @return CHECK_FLAG 管理员后台对任务组的审核结果：
 0:未通过；1:已通过
     */
     ...
     * 管理员后台对任务组的审核结果：
 0:未通过；1:已通过
     * @param checkFlag 管理员后台对任务组的审核结果：
 0:未通过；1:已通过
     */
    ...
    /**
     * 任务组状态：0:未完成；1:已完成
     * @return TASK_GROUP_STATUS 任务组状态：0:未完成；1:已完成
     */
    ...
    /**
     * 任务组状态：0:未完成；1:已完成
     * @param taskGroupStatus 任务组状态：0:未完成；1:已完成
     */
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTaskGroupStatus() == null ? other.getTaskGroupStatus() == null : this.getTaskGroupStatus().equals(other.getTaskGroupStatus()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTaskGroupStatus() == null) ? 0 : getTaskGroupStatus().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", specialCondition=").append(specialCondition);
        ...
        sb.append(", taskGroupStatus=").append(taskGroupStatus);
