 ...
 * @version $Id$
 * 
 * 类功能描述: SQL session工厂类
 * @className SqlSessionFactoryBean.java
 * 
 * @author Allen Gong
 * @version 1.0
 * 
 * @history 2017-01-01 Allen Gong 创建 SqlSessionFactoryBean.java
 */
public class SqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
  ...
  public void setMapperFolder(Resource[] mapperFolder) {
  ...
  protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
    ...
    if (!isEmpty(this.mapperLocations)) {
    	Resource[] mapperResources = this.mapperLocations;
    	if(!isEmpty(this.mapperFolder)){
    		mapperResources = concat(mapperResources, this.mapperFolder);
    	}
